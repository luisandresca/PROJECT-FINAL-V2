...
<html lang="en">
  ...
  <li><a href="signup.php?lang=fr&catidv=2">Enregistrez-vous</a></li>
      ...
      <div class="overlay">
        <div class="container">
          <div class="main-text">
            ...
            <p class="sub-title">  Achetez et vendez tout ce que vous désirez: votre voiture, un téléphone, un ordinateur ou encore un bien immobilier </p>
              ...
              <div class="advanced-search">
                <form class="search-form" method="get">
                  ...
                  <div class="col-md-3 col-sm-6 search-col">
                    <input class="form-control keyword" name="keyword" value="" placeholder="Entrez le mot que vous désirez rechercher" type="text">
                    <i class="fa fa-search"></i>
                  </div>
                  <div class="col-md-3 col-sm-6 search-col">
                    <button class="btn btn-common btn-search btn-block"><strong>Recherchez</strong></button>
                  </div>
                </form>
              </div>
            </div>
